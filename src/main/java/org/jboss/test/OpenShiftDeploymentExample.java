...
public class OpenShiftDeploymentExample {

	private static final Logger logger = LoggerFactory.getLogger(OpenShiftDeploymentExample.class);

	public static void main(String[] args) throws Exception {

		AuthArgs cmdArgs = new AuthArgs();
		JCommander cmdParser = new JCommander(cmdArgs);
		try {
			cmdParser.setProgramName(OpenShiftDeploymentExample.class.getName());
